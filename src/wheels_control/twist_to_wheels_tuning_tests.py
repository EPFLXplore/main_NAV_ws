...
def callback(twist, verbose=False):
    """
    components of Twist() :
    twist.linear.x
    twist.linear.y
    ...
    tf_lin_data_fields[1] = tf_lin_data_fields[1] - turn_radius
    ...
    if verbose:
        ...
        print("l1_to_icr = " + str(l1_to_icr))
        print("l2_to_icr = " + str(l2_to_icr))
        print("l3_to_icr = " + str(l3_to_icr))
        print("r1_to_icr = " + str(r1_to_icr))
        print("r2_to_icr = " + str(r2_to_icr))
        print("r3_to_icr = " + str(r3_to_icr))
